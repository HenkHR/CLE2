...
<main>
    <p class="flex justify-center" style="color: var(--colors-text); font-size: var(--font-size-very-large); font-weight: bold">Reserveringsoverzicht</p>
    <div class="title" style="margin-top: 5vh">
        <a href="?week=<?= $selectedWeek - 1 ?>">Vorige week</a>
            <span>
                ...
                </a> <?= $monthOfWeek . ' ' . $yearOfWeek; ?><br> Week: <?= date("W", $timestampWeek) ?> <br> <?php if ($selectedWeek != 0) { ?>
            <?php } ?></span>
