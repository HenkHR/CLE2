<footer class="row">
    <div class="footer-contact">
        ...
        <p>
            <span style="color: var(--colors-link); font-size: var(--font-size-bigger)">|</span> <span
                    style="color: var(--colors-text); font-size: var(--font-size-bigger)">Middelharnis</span>
        </p>
        <p>
            Industrieweg 38 <br>
    ...
    <div class="footer-location-contact">
        <div class="footer-info">
            <p>
                <span style="color: var(--colors-link); font-size: var(--font-size-bigger)">|</span> <span
                        style="color: var(--colors-text); font-size: var(--font-size-bigger)">Oude-Tonge</span>
            </p>
            <p>
                Stationsweg 18 <br>
        ...
        <p>
            <span style="color: var(--colors-link); font-size: var(--font-size-bigger)">|</span> <span
                    style="color: var(--colors-text); font-size: var(--font-size-bigger)">Ouddorp</span>
        </p>
        <p>
            Boompjes 9 <br>
            3253 AC Ouddorp <br>
