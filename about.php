    ...
    <div class="info" style="color: var(--colors-text)">
        <div class="leftItem">
            ...
            <p>
                ...
                Wij vinden gastvrijheid en connectie met de klanten erg belangrijk, we hebben hierom ook op elke locatie
                een bar en een lounge om gezellig een bakje koffie of een eiwitsmoothie te drinken.
                Ook bieden wij gratis persoonlijke begeleiding aan binnen ons fitnessabonnement.
                Verder hebben wij ook een groot assortiment aan groepslessen. <br> Meer weten? <br> Kijk dan op onze
                website!
            </p>
        ...
        <div class="rightItem">
            ...
            <p>
                ...
                Mocht je vragen hebben over wat de producten voor jou kunnen betekenen dan kun je dit altijd vragen aan
